...
public class MostrarComponente extends JDialog {
	...
	public static void main(String[] args) {
		try {
			MostrarComponente dialog = new MostrarComponente();
	...
	public MostrarComponente() {
		...
		contentPanel.setLayout(null);
		{
			...
			textField.setBounds(239, 108, 136, 20);
			panel.add(textField);
			
			textField_1 = new JTextField();
			textField_1.setEditable(false);
			textField_1.setColumns(10);
			textField_1.setBounds(239, 160, 136, 20);
			panel.add(textField_1);
			
			textField_2 = new JTextField();
			textField_2.setEditable(false);
			textField_2.setColumns(10);
			textField_2.setBounds(239, 187, 136, 20);
