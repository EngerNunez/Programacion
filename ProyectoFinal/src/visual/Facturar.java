...
public class Facturar extends JDialog {
	...
	public Facturar() {
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(Facturar.class.getResource("/imagenes/Logotipo ELITE ELECTRONICS.png")));
		setTitle("Facturar");
		...
		btnComponenteIzquierda.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				total -= Float.valueOf(carrito.get(selected).substring(carrito.get(selected).indexOf(" ") + 6,
						carrito.get(selected).length()));
		...
		btnComponentesDerecho.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				total += Float.valueOf(
						carrito.get(ind).substring(carrito.get(ind).indexOf(" ") + 6, carrito.get(ind).length()));
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				ButtonFacturar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if (cliente == null) {
							cliente = new Cliente(txtCedula.getText(), txtNombre.getText(), txtDireccion.getText(),
									txtTelefono.getText());
